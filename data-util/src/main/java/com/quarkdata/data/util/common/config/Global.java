 ...
 */
package com.quarkdata.data.util.common.config;

//import com.ckfinder.connector.ServletContextFactory;
import com.google.common.collect.Maps;
import com.quarkdata.data.util.PropertiesLoader;
...
//		System.out.println("userfiles.basedir: " + dir);
	...
	public static void modifyConfig(String key, String value) {
		try {
			...
			String path = Global.class.getResource("/config/config.properties").getPath();
