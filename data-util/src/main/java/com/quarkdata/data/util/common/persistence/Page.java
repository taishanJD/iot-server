 ...
 */
package com.quarkdata.data.util.common.persistence;

import com.fasterxml.jackson.annotation.JsonIgnore;
import com.quarkdata.data.util.CookieUtils;
import com.quarkdata.data.util.common.config.Global;
...
public class Page<T> {
	...
	public Page(int pageNo, int pageSize, long count, List<T> list) {
		...
		this.list = list;
		if(pageSize>0){//如果pagesize有值，就初始化参数
			initialize();
		}else{
			this.pageNo=1;
			this.pageSize=10;
...
//		sb.append("</div>");
		...
		sb.append("<li class=\""+getSelected(pageSize,10)+ "\"><a href=\"javascript:"+funcName+"("+1+",10,'"+funcParam+"');\">10</a></li>");
		sb.append("<li class=\""+getSelected(pageSize,25)+ "\"><a href=\"javascript:"+funcName+"("+1+",25,'"+funcParam+"');\">25</a></li>");
		sb.append("<li class=\""+getSelected(pageSize,50)+ "\"><a href=\"javascript:"+funcName+"("+1+",50,'"+funcParam+"');\">50</a></li>");
		sb.append("<li class=\""+getSelected(pageSize,100)+ "\"><a href=\"javascript:"+funcName+"("+1+",100,'"+funcParam+"');\">100</a></li>");
		sb.append("</ul>");
