...
public class AesUtil {
    ...
    public static String encrypt(String content) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, UnsupportedEncodingException, IllegalBlockSizeException, BadPaddingException {  
 	   byte[] result=encrypt(content,password);
     	//logger.info("xxxxxxxx content:"+content+", password:"+props.get("aes_password")+",result:"+new String(result)
     	//+", parseByte2HexStr(result):"+parseByte2HexStr(result));
     	return parseByte2HexStr(result);
     }
     
     public static String decrypt(String content) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException {  
